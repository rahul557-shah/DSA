// Minimum Insertions to make a string Palindrome(Leetcode Q.1312)
#include <bits/stdc++.h>
using namespace std;
...
int LPS(string s1)
{
    ...
    return m - fun2(m - 1, m - 1, s1, s2, dp);
}
...
int main()
{
    ...
    cin >> s1;
    cout << "Minimum Insertion to make a string Palindrome is: " << fun4(s1) << endl;
}
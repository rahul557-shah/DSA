// Delete Operation for two strings(Leetcode Q.583)
// Minimum Number of Insertion and Deletion(GFG and Coding Ninjas)
#include <bits/stdc++.h>
using namespace std;
...
int lcs(string s1, string s2)
{
    ...
    return m + n - 2 * fun2(m - 1, n - 1, s1, s2, dp);
}
...
int main()
{
    ...
    cout << s2 << endl;
    cout << "Minimum Number of Insertions and Deletions required is: " << fun4(s1, s2) << endl;
    return 0;
}